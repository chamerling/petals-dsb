...
public class SOAPHttpTransportListener implements TransportListener {
    ...
    public SOAPHttpTransportListener(SoapServerConfig config) {
        this.config = config;
    }
    ...
    public EndpointReference[] getEPRsForService(String serviceName, String ip) throws AxisFault {
        if (this.config != null) {
            return this.config.getEPRsForAxisService(serviceName, Constants.TRANSPORT_HTTP);
        } else {
            throw new AxisFault("Unable to generate EPR for the transport: " + Constants.TRANSPORT_HTTP);
        }
    }
    ...
    public void init(ConfigurationContext axisConf, TransportInDescription transprtInDesc)
            throws AxisFault {
        this.config.initTransportListenerForAxis(transprtInDesc, Constants.TRANSPORT_HTTP);
    }
