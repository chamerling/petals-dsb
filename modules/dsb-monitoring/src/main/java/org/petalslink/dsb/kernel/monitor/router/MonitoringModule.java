...
public interface MonitoringModule {
     ...
     * @return MessageExchange
     */
    public org.ow2.petals.tools.monitoring.to.MessageExchange getMessageExchange(final String exchangeId);
     ...
     */
    public List<org.ow2.petals.tools.monitoring.to.MessageExchange> getMessageExchanges(final Date begin, final Date ending);
