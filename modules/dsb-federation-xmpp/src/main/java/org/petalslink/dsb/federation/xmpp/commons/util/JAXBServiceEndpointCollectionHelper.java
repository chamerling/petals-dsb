 ...
 * 
 */
public class JAXBServiceEndpointCollectionHelper {
    ...
    static {
        try {
            final JAXBContext jaxbContext = JAXBContext
                    .newInstance(new Class[] { ServiceEndpointCollection.class });
     ...
     * @param os
     */
    public static final void marshall(ServiceEndpointCollection serviceEndpoint, OutputStream os)
            throws MessageExchangeException {
        if ((serviceEndpoint != null) && (os != null)) {
            try {
                JAXBElement<ServiceEndpointCollection> element = new JAXBElement<ServiceEndpointCollection>(
                        new QName("org.petalslink.dsb.api", "ServiceEndpointCollection"),
                        ServiceEndpointCollection.class, null, serviceEndpoint);
     ...
     * @throws MessageExchangeException
     */
    public static final ServiceEndpointCollection unmarshall(InputStream is)
            throws MessageExchangeException {
        ServiceEndpointCollection m = null;
        if (is != null) {
            try {
                final JAXBElement<ServiceEndpointCollection> root;
                // The default Xerces unmarshaller is not thread safe
                synchronized (unmarshaller) {
                    root = unmarshaller.unmarshal(new StreamSource(is),
