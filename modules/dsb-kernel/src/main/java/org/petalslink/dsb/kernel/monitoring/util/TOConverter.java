...
public class TOConverter {
    ...
    public static org.ow2.petals.tools.monitoring.to.MessageExchange convert(final MessageExchangeImpl exchange, final org.objectweb.util.monolog.api.Logger logger) throws RoutingException, IOException, IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException{
        ...
        final org.ow2.petals.tools.monitoring.to.ServiceEndpoint endpointTO = convert((org.ow2.petals.jbi.messaging.endpoint.ServiceEndpoint)exchange.getEndpoint());
        ...
        if(exchange.getConsumerEndpoint() != null && exchange.getConsumerEndpoint().getLocation() != null){
            exchangeTO.setConsumer(exchange.getConsumerEndpoint().getLocation().getComponentName());
        }
        if(exchange.getEndpoint() != null && ((org.ow2.petals.jbi.messaging.endpoint.ServiceEndpoint)exchange.getEndpoint()).getLocation() != null){
            exchangeTO.setProvider(((org.ow2.petals.jbi.messaging.endpoint.ServiceEndpoint)exchange.getEndpoint()).getLocation().getComponentName());
        }
        /*
         * If an error is available marshal
         * this into a string
         */
        ...
        /*
         * If a fault is available convert it
         * into a transfert object
         */
        ...
        /*
         * If a in is available convert it
         * into a transfert object
         */
        ...
        /*
         * If a out is available convert it
         * into a transfert object
         */
    ...
    public static List<org.ow2.petals.tools.monitoring.to.Property> getProperties(final MessageExchange exchange) {
        ...
        if(set != null){
            ...
            for(int i = 0 ; i < keys.length ;i ++){
                ...
                property = new org.ow2.petals.tools.monitoring.to.Property(key,exchange.getProperty(key).toString());
                } else {
    ...
    public static org.ow2.petals.tools.monitoring.to.ExchangeStatus convert(final ExchangeStatus status) {
    ...
    public static org.ow2.petals.tools.monitoring.to.Role convert(final Role role) throws IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException {
        if(role != null){
    ...
    public static org.ow2.petals.tools.monitoring.to.NormalizedMessage convert(final NormalizedMessage nm, final org.objectweb.util.monolog.api.Logger logger) {
        ...
        try {
            ...
            logger.log(Logger.INFO, "[Error occured during the normalized message conversion in the monitoring module]: "+e.getMessage());
