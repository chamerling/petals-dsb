...
/**
 * The web service which handle remote checks
 * 
...
@Provides(interfaces = { @Interface(name = "service", signature = KernelWebService.class),
        @Interface(name = "webservice", signature = RemoteCheckerService.class) })
public class RemoteCheckerServiceImpl implements KernelWebService, RemoteCheckerService {
    ...
    public boolean ping() throws PEtALSWebServiceException {
        ...
        // TODO : Can be updated to say that the local container is not
        // reachable (maintenance, migration, ...)
        return true;
    }
