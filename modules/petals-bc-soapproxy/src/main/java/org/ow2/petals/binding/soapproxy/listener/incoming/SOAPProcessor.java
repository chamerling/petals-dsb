...
import static org.ow2.petals.binding.soapproxy.Constants.SOAP.FAULT_CLIENT;
...
public class SOAPProcessor extends RequestProcessor {
    ...
    /* (non-Javadoc)
     * @see org.ow2.petals.binding.soapproxy.listener.incoming.RequestProcessor#process(org.apache.axis2.context.MessageContext, org.apache.axiom.soap.SOAPFactory)
     */
    @Override
    protected MessageContext process(final MessageContext inContext,
        ...
        QName jbiOperation;        
        jbiOperation = this.retrieveSOAPOperation(inContext, soapAction, axisService);
    ...
    protected QName retrieveSOAPOperation(final MessageContext inContext, String soapAction, PetalsAxisService axisService) {
        ...
        try {
            ...
            if(res == null) {
                ...
                QName serviceName = axisService.getServiceName();
