...
import org.ow2.petals.binding.soapproxy.util.WsdlHelper;
...
public class PetalsAxisService extends AxisService {
     ...
     * @param extensions
     */
    public PetalsAxisService(final String name, final String endpointName, QName serviceName,
            QName interfaceName, final ComponentContext componentContext,
    ...
    public void printWSDL(final OutputStream out, final String requestIP) throws AxisFault {
        ...
        try {
            ...
            XMLPrettyPrinter.prettify(this.descWithoutImport, out, XMLPrettyPrinter
                    .getEncoding(this.descWithoutImport));
    ...
    private void generateComplexWSDL(final String rootURI) throws AxisFault {
        ...
        try {
            ...
            this.descWithoutImport = WSDL4ComplexWsdlFactory.newInstance().newWSDLWriter()
                    .getDocument(this.desc);
        } catch (final Exception e) {
            throw new AxisFault("Server", e);
        }
    ...
    public ServiceEndpoint getServiceEndpoint() {
        ...
        if ((this.endpointName != null) && (this.serviceName != null)) {
            ...
            jbiEndpoint = this.componentContext.getEndpoint(this.serviceName, this.endpointName);
        } else if (this.interfaceName != null) {
            // get from ITF value
            final ServiceEndpoint[] endpoints = this.componentContext
                    .getEndpoints(this.interfaceName);
