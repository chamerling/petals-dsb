...
/**
 * Taken from Quartz org.quartz.CronExpression.class
 * 
 * @author chamerling
 * 
 */
public class CronExpressionValidator {
     ...
     */
    public CronExpressionValidator(String cronExpression) throws ParseException {
        if (cronExpression == null) {
            throw new ParseException("cronExpression cannot be null", -1);
        }
    ...
    public static boolean isValidExpression(String cronExpression) {
        ...
        try {
            new CronExpressionValidator(cronExpression);
        ...
        try {
            ...
            while (exprsTok.hasMoreTokens() && exprOn <= YEAR) {
                ...
                if (exprOn == DAY_OF_WEEK && expr.indexOf('#') != -1
                    ...
                    throw new ParseException(
                            "Support for specifying multiple \"nth\" days is not imlemented.", -1);
                }
    ...
    public Object clone() {
        CronExpressionValidator copy = null;
        try {
            copy = new CronExpressionValidator(getCronExpression());
            if (getTimeZone() != null)
