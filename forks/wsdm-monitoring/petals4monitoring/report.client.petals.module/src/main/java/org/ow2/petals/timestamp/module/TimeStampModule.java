...
public class TimeStampModule implements SenderModule, ReceiverModule {
	...
	private void setTimeStamp(MessageExchange exchange) {
		...
		if(t != null) {
			this.log.info(t + "timestamp the messageExchange (" + exchange.getExchangeId() + "): " + date.getTime());
			System.out.println(t + "timestamp the messageExchange (" + exchange.getExchangeId() + "): " + date.getTime());
		}
	}
