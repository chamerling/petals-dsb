...
/**
 * <p>Java class for DurationMetric complex type.
 * 
...
@XmlType(name = "DurationMetric", propOrder = {
    "value"
})
@XmlSeeAlso({
...
public class DurationMetric {
    ...
    protected XMLGregorianCalendar resetAt;
     ...
     *     
     */
    public XMLGregorianCalendar getResetAt() {
        return resetAt;
    }
     ...
     *     
     */
    public void setResetAt(XMLGregorianCalendar value) {
        this.resetAt = value;
    }
