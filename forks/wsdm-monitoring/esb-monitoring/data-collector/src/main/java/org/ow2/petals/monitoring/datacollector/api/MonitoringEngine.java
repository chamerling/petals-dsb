 ...
 */
@Interface(name = "dataEngine")
public interface MonitoringEngine extends
		org.ow2.petals.monitoring.core.api.MonitoringEngine {

	DataCollector createDataCollector() throws MonitoringException;
