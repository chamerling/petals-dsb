...
public class RawReportProviderEndpointImpl extends
		ClientAndProviderEndpointImpl implements RawReportProviderEndpoint {
	...
	private static Logger log = Logger
			.getLogger(RawReportProviderEndpointImpl.class.getName());
