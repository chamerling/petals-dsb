...
public class MonitoringClientEndpointImpl extends ClientAndProviderEndpointImpl
		implements MonitoringClientEndpoint {
	...
	private static Logger log = Logger
			.getLogger(MonitoringClientEndpointImpl.class.getName());
