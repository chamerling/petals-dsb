 ...
 * element interface generated in the net.webservicex package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _String_QNAME = new QName(
			"http://www.webserviceX.NET/", "string");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: net.webservicex
	 * 
	 */
	...
	public JAXBElement<String> createString(final String value) {
		return new JAXBElement<String>(ObjectFactory._String_QNAME,
